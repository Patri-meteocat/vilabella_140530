...
out_path = '/home/pav/repos/vilabella_140530/v_plots/'
...
for f in glob.glob(data_path + '*.pkl'):
    ...
    for nsw, sweep_slice in enumerate(radar.iter_slice()):
        ...
        display.plot('velocity', nsw, ax=ax, vmin=-Vny, vmax=Vny, mask_outside=False, cmap=cmap_vel, colorbar_flag=True, title_flag=False, colorbar_label='[m/s]')
        # Display range rings
